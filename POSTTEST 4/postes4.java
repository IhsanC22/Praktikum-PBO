...
class DagingOlahan extends Daging {
    ...
    @Override
    public String toString() {
        return super.toString() + ", Metode Pengolahan: " + metodePengolahan;
    }
}
...
class DagingSegar extends Daging {
    ...
    @Override
    public String toString() {
        return super.toString() + ", Tingkat Kesegaran: " + tingkatKesegaran;
    }
}
...
public class postes4 {
    ...
    private static void tambahDaging(Scanner scanner) {
        ...
        switch (jenisDaging) {
            case 1:
                ...
                tambahDaging(new DagingOlahan(idSelanjutnya++, jenis, harga, metodePengolahan));
                break;
            case 2:
                System.out.print("Masukkan tingkat kesegaran: ");
                tingkatKesegaran = scanner.nextInt();
                tambahDaging(new DagingSegar(idSelanjutnya++, jenis, harga, tingkatKesegaran));
                break;
            default:
                System.out.println("Pilihan tidak valid");
        }
    ...
    private static void tambahDaging(Daging daging) {
        inventarisDaging.add(daging);
    ...
    private static void hapusDaging(Scanner scanner) {
        ...
        if (dagingToDelete != null) {
            inventarisDaging.remove(dagingToDelete);
