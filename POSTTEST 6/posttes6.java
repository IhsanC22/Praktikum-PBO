...
class DagingOlahan extends Daging {
    private final String metodePengolahan;
    ...
    public void displayDetail() {
        System.out.println("Metode Pengolahan: " + metodePengolahan);
    }
}

class DagingSegar extends Daging {
    private final int tingkatKesegaran;
    ...
    @Override
    public void displayDetail() {
        System.out.println("Tingkat Kesegaran: " + tingkatKesegaran);
    }
}

public class posttes6 implements ErrorHandling {
    private static final List<Daging> inventarisDaging = new ArrayList<>();
    private static final int idSelanjutnya = 1;
